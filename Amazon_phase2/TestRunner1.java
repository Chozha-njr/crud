...
@CucumberOptions(features = "\"C:\\Users\\DELL\\eclipseworkspace\\CucumberProject\\Amazon\\src\\test\\java\\feature\\Amazon.feature",
...
/*
* - cucumber report - Extent report - Cucumber reports 
in PDF format - HTML
* Reports - TestNG Reports
* 
* Various Cucumber options or properties :
* 
* features : comma separted paths to feature file. 
dryRun=true : It will check
* if every steps has an step defination method 
implemented or not glue : comma
* separated package names of step def. file plugin = 
pretty : Tags
* 
*/
}