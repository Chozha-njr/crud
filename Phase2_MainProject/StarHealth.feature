...
When User clicks on the Buy Now button Then User types Name as "<FullName>" Then User types Phone as "<PhNo>" Then User types the PIN as "<PIN>"
...
Then The Application should redirect to the home page When User closes the child tab
Then User navigates back to the parent tab Examples:

| URL	                       | FullName | PhNo	    | PIN	   | optionPlan |
| https://www.starhealth.in/ | Userdemo	| 9999999999| 530009 | My Family  |